...
print("2019 DATA:")
print("    class 0: %d" % len(new_df.loc[new_df['diagnoisis'] == 0])
print("    class 1: %d" % len(new_df.loc[new_df['diagnoisis'] == 1])
print("    class 2: %d" % len(new_df.loc[new_df['diagnoisis'] == 2])
print("    class 3: %d" % len(new_df.loc[new_df['diagnoisis'] == 3])
print("    class 4: %d" % len(new_df.loc[new_df['diagnoisis'] == 4])
print("2015 DATA:")
