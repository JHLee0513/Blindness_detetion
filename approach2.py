...
model_name = 'raw_effnet_pretrained_regression_fold_v20_snap'
...
save_model_name = f'{path}/blind_weights/snap_trash.hdf5'
...
for cv_index in range(3):
    ...
    model.load_weights(save_model_name)
    model.save(f'{path}/blind_weights/'+model_name+str(cv_index+1)+'.h5')
